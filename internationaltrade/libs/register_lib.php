...
if ($var_type==='seller') 
	...
	$sql="insert into register(type,email,password,first_name,last_name,food_category,electronics_category,rawmaterial_Category,entertainment_Category,Address,mobile_number,receive_message)values('$var_type','$var_buyer_email','$var_buyer_password','$var_buyer_first_name','$var_buyer_last_name','$var_buyer_category_food','$var_buyer_category_electronics','$var_buyer_category_rawmaterial','$var_buyer_category_entertainment','$var_buyer_addr','$var_buyer_mobile_number','$var_buyer_rev_msg')";
	}
