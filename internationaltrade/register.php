                    ...
                    <div class="container">
                            ...
                            <div class="span5 contact-form centered">
								...
								<div class="buyer_form" style="display:none;" >
									...
									<div class="control-group">
                                        <div class="controls">
											<input class="span5" type="text" name="buyer_mobile_number" id="buyer_mobile_number" placeholder="* Mobile Number..." value="<?php echo $buyer_mobile_number_value;?>" required />
