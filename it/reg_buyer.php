                ...
                <div class="container theme-container">
                    ...
                    <ul class="pull-right list-unstyled list-inline">
						...
						echo"<li class='menu-item'>";
								...
								if (isset($_SESSION["uid"])) 
									{
									echo"<a href='profile.php'> hi user , ".$_SESSION['uname']."</a>";
									}
								else
									{
        ...
        <div class="main-wrapper clearfix">
			...
			<section class="gst-compare">
                ...
                <div class="gst-column col-lg-12 col-md-6 col-sm-12 col-xs-12">
					...
					<h2> <i class="fa fa-user fa-2x thm-clr"></i> Register Here With Advanced Group Marketing as <span class="thm-clr">Buyer</span></h2>
					<div class="gst-column col-lg-6">
						
							<p></p>
							
							<div class="form-group">
								<input type="email" placeholder="* Enter your email address" name="buyer_email" id="buyer_email" class="form-control" value="<?php echo $buyer_email_value;?>" required />
								<?php $validator->out_field_error('buyer_email');?>
							</div>
							
                            <div class="form-group">
								<input type="password" placeholder="* Enter your Password" name="buyer_pwd" id="buyer_pwd" class="form-control" value="<?php echo $buyer_pwd_value;?>" required />
								<?php $validator->out_field_error('buyer_pwd');?>
							</div>
							
							<div class="form-group">
								<input  class="form-control" type="password" name="buyer_pwd_repeat" id="buyer_pwd_repeat" placeholder="* Repeat Password here" value="<?php echo $buyer_pwd_repeat_value;?>" required />
								<?php $validator->out_field_error('buyer_pwd_repeat');?>
							</div>
							
							<div class="form-group">
								<input class="form-control" type="text" name="buyer_first_name" id="buyer_first_name" placeholder="* First Name..." value="<?php echo $buyer_first_name_value;?>" required />
								<?php $validator->out_field_error('buyer_first_name');?>
							</div>
							
							<div class="form-group">
								<input class="form-control" type="text" name="buyer_last_name" id="buyer_last_name" placeholder="* Last Name..." value="<?php echo $buyer_last_name_value;?>" required />
								<?php $validator->out_field_error('buyer_last_name');?>
							</div>
						<div class="form-group">
								<textarea class="form-control" name="buyer_addr" id="buyer_addr" placeholder="* Address..." required><?php echo htmlspecialchars($buyer_addr_value, ENT_QUOTES, 'UTF-8'); ?></textarea>
					...
					<div class="gst-column col-lg-6">
							...
							<div class="form-group">
								<input class="form-control" type="text" name="buyer_mobile_number" id="buyer_mobile_number" placeholder="* Contact no..."value="<?php echo $buyer_mobile_number_value;?>" required />
								<?php $validator->out_field_error('buyer_mobile_number');?>
							</div>
							
							<div class="form-group">
								<select class="form-control" name="buyer_rev_msg" id="buyer_rev_msg">
